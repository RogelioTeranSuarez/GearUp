  ...
  return (
    ...
    <>
      <Container style={{ display: 'flex', marginLeft: '0px', height: '100vh', maxWidth: '100vw' }}>
        ...
        <div style={{ width: '15%', height: '100%', backgroundColor: 'rgb(219, 169, 0)', color: 'white', padding: '10px' }} >
          ...
          <div style={{ paddingTop: '145%', bottom: '50px' }}>
            <Nav>
              <Button variant="outline-light" as={Link} to="ProfileDs" style={{ width: '100%', marginBottom: '10px' }}>Profile</Button>
            </Nav>
            <Nav>
              <Button variant="outline-light" as={Link} to="SignIn" style={{ width: '100%', marginBottom: '10px' }}>Log Out</Button>
            </Nav>
          </div>
        </div>
